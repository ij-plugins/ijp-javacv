...
val commonSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "org.bytedeco"   % "opencv"     % "4.4.0-1.5.5-SNAPSHOT" withSources() withJavadoc(),
    "org.bytedeco"   % "opencv"     % "4.4.0-1.5.5-SNAPSHOT" classifier platform,
    "org.bytedeco"   % "openblas"   % "0.3.10-1.5.5-SNAPSHOT" withSources() withJavadoc(),
    "org.bytedeco"   % "openblas"   % "0.3.10-1.5.5-SNAPSHOT" classifier platform,
    "net.imagej"     % "ij"         % "1.53g",
